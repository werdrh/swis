...
if (iconMenu != null) {
	let delay = 500;
	let blure = document.querySelector(".menu__body");
	...
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			...
			blure.classList.toggle("_active");
		}
	});

	blure.addEventListener("click", function (e) {
		if (unlock) {
...
window.addEventListener("keydown", function (e) {
	...
	let iconMenu = document.querySelector(".icon-menu");
	let menuBody = document.querySelector(".header__menu");
	if (e.keyCode == 27 && menuBody.classList.contains('_active')) {
		iconMenu.classList.remove("_active");
		menuBody.classList.remove("_active");
		blure.classList.remove("_active");
	}
}, true);
...
let popupAplication = document.querySelector(".popup_popup");
let popupShow = document.querySelector(".show");
let myForm = document.querySelector(".popup__form");
let popupMesage = document.querySelector(".popup_massagename-message");
let applyBtn = document.querySelectorAll('.apply-btn');
let popupClose = document.querySelectorAll(".popup__close");
let popupBg = document.querySelectorAll(".popup__bg");
let popupMail = document.querySelector(".popup__mail");
let popupMailForm = document.querySelector(".footer__top-form");


applyBtn.forEach(function (tn) {
  tn.addEventListener("click", function () {
    popupAplication.classList.add("show");
  });
});
...
myForm.addEventListener('submit', function () {
  popupAplication.classList.remove("show");
  popupMesage.classList.add("show");
  

});


  popupMailForm.addEventListener('submit', function () {
    popupMail.classList.add("show");
...
popupClose.forEach(function (btn) {
  btn.addEventListener("click", function () {
    if (popupAplication.classList.contains('show')) {
      popupAplication.classList.remove('show');

    }
    if (popupMesage.classList.contains('show')) {
      popupMesage.classList.remove('show');
      window.location.reload();
    }
   
    if (popupMail.classList.contains('show')) {
      popupMail.classList.remove('show');
      window.location.reload();
    }
  }, true)
});

popupBg.forEach(function (c) {
...
window.addEventListener("keydown", function (e) {
  if (e.keyCode == 27 && popupAplication.classList.contains('show')) {
    popupAplication.classList.remove('show');

  }
  if (e.keyCode == 27 && popupMesage.classList.contains('show')) {
    popupMesage.classList.remove('show');
    window.location.reload();
  }
 
  if (e.keyCode == 27 && popupMail.classList.contains('show')) {
    popupMail.classList.remove('show');
